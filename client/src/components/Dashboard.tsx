        ...
        <div className="dashboard-container">
            ...
            <main className="container">
                ...
                <section className="services-grid">
                    {filteredServices.map((service, index) => (
                        <div
                            ...
                            <div
                                className={`status-indicator ${getStatusClass(service.status)}`}></div>
                            ...
                            <div className="service-content">
                                ...
                                <p>
                                    {service.status === 'online' ? (
                                        ...
                                        <span style={{color: 'orange'}}>Service is offline</span>
                                    )}
                                </p>
                            </div>
                ...
                <footer className="footer">
                    <p>
                        &copy; 2025 Shvydak Dashboard. Made with <i className="fas fa-heart"></i>
                    </p>
                </footer>
            </main>
        </div>
